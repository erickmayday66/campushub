...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="avatar-large">Shield</div>
        ...
        <div class="sidebar-nav">
            ...
            <a href="{{ route('admin.students.index') }}">Student Management</a>
            <a href="{{ route('admin.courses.index') }}">Course Management</a>
            <a href="{{ route('admin.faculties.index') }}" class="active">Faculty Management</a>
    ...
    <div class="main-content">
        ...
        <div class="form-card">
            ...
            <form action="{{ route('admin.faculties.update', $faculty->id) }}" method="POST">
                ...
                <!-- Back (left) → Update Faculty (right) -->
