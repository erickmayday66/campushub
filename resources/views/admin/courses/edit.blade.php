...
<head>
    <meta charset="UTF-8">
    <title>Edit Course | CampusHub Admin</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="header-card">
            <h1>Edit Course</h1>
            <p>Update course details including name, code, duration, and assigned faculty.</p>
        </div>
        ...
        <div class="form-card">
            ...
            <form action="{{ route('admin.courses.update', $course->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('name', $course->name) }}" required placeholder="e.g., Computer Science">
                </div>

                <div class="form-group">
                    <label class="form-label">Course Code</label>
                    <input type="text" name="code" class="form-control" value="{{ old('code', $course->code) }}" required placeholder="e.g., CS">
                </div>

                <div class="form-group">
                    <label class="form-label">Duration (Years)</label>
                    <input type="number" name="duration_years" class="form-control" value="{{ old('duration_years', $course->duration_years) }}" min="1" max="10" required>
                </div>
