...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-nav">
            <li><a href="#" class="active"><i class="fas fa-home"></i> Dashboard <span class="badge">New</span></a></li>
            <li><a href="#"><i class="fas fa-user-cog"></i> User Management</a></li>
            <li><a href="#"><i class="fas fa-users"></i> Student Management</a></li>
            <li><a href="#"><i class="fas fa-poll"></i> Election Results</a></li>
    ...
    <div class="main-content" id="main-content">
        ...
        <div class="stat-card">
            <div class="value">{{ $systemUptime }}% <span class="trend up">+0.5%</span></div>
            <div class="label"><i class="fas fa-server"></i> System Uptime</div>
        ...
        <div class="dashboard-grid">
            ...
            <div>
                <!-- System Analytics -->
                <div class="section-title" style="font-size:1.25rem; font-weight:600; color:#2c3e50; display:flex; align-items:center; gap:8px;">
                    <i class="fas fa-chart-line" style="color:#3498db;"></i> System Analytics
                </div>
...
<script>
    ...
    const analyticsChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: @json($analyticsLabels), // ['Jan','Feb','Mar', ...]
            datasets: [{
                label: 'Active Users',
                data: @json($analyticsData), // [120,150,180,...]
                fill: true,
