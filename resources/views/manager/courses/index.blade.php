...
<head>
    <meta charset="UTF-8">
    <title>Manage Courses | CampusHub</title>
                    ...
                    <tbody>
                        @forelse ($courses as $index => $course)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('manager.courses.edit', $course->id) }}" class="btn btn-sm btn-outline-secondary">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('manager.courses.destroy', $course->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
