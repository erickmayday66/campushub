...
<head>
    <meta charset="UTF-8">
    <title>Edit Course | CampusHub</title>
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h3><i class="fas fa-book"></i> Edit Course</h3>
        </div>

        <div class="card">
            <div class="card-body">
                <form action="{{ route('manager.courses.update', $course->id) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="form-group">
                        <label for="name" class="form-label">Course Name</label>
                        <input type="text" class="form-control" id="name" name="name" required value="{{ $course->name }}">
                    </div>

                    <div class="form-group">
                        <label for="code" class="form-label">Course Code</label>
                        <input type="text" class="form-control" id="code" name="code" required value="{{ $course->code }}">
                    </div>

                    <div class="form-group">
                        <label for="duration_years" class="form-label">Duration (Years)</label>
                        <input type="number" min="1" max="10" class="form-control" id="duration_years" name="duration_years" required value="{{ $course->duration_years }}">
                    </div>
