...
<head>
    <meta charset="UTF-8">
    <title>Add Election | CampusHub</title>
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h3><i class="fas fa-bullhorn"></i> Add New Election</h3>
        </div>

        <div class="card">
            <div class="card-body">
                <form action="{{ route('manager.elections.store') }}" method="POST">
                    @csrf

                    <div class="form-group">
                        <label for="title" class="form-label">Election Title</label>
                        <input type="text" class="form-control" id="title" name="title" required placeholder="e.g., University President">
                    </div>
                    ...
                    <div class="form-group d-none" id="faculty-group">
                    ...
                    <div class="form-group d-none" id="course-group">
                        ...
                        <select class="form-select" id="course_id" name="course_id">
                            ...
                            @foreach ($courses as $course)
                                <option value="{{ $course->id }}" data-faculty="{{ $course->faculty_id }}">{{ $course->name }}</option>
                            @endforeach
                        </select>
                    </div>
    ...
    <script>
        ...
        facultySelect.addEventListener('change', function () {
            ...
            // Show only courses belonging to selected faculty
