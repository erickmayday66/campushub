...
<head>
    <meta charset="UTF-8">
    <title>Add Faculty | CampusHub</title>
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h3><i class="fas fa-university"></i> Add New Faculty</h3>
        </div>

        <div class="card">
            <div class="card-body">
                <form action="{{ route('manager.faculties.store') }}" method="POST">
                    @csrf

                    <div class="form-group">
                        <label for="name" class="form-label">Faculty Name</label>
                        <input type="text" class="form-control" id="name" name="name" required placeholder="e.g., Faculty of Science">
                    </div>

                    <div class="form-group">
                        <label for="code" class="form-label">Faculty Code</label>
                        <input type="text" class="form-control" id="code" name="code" required placeholder="e.g., FSCI">
                    </div>

                    <div class="button-group">
                        <a href="{{ route('manager.faculties.index') }}" class="btn btn-secondary">
