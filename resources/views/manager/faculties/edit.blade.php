...
<head>
    <meta charset="UTF-8">
    <title>Edit Faculty | CampusHub</title>
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h3><i class="fas fa-university"></i> Edit Faculty</h3>
        </div>

        <div class="card">
            <div class="card-body">
                <form action="{{ route('manager.faculties.update', $faculty->id) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="form-group">
                        <label for="name" class="form-label">Faculty Name</label>
                        <input type="text" class="form-control" id="name" name="name" required value="{{ $faculty->name }}">
                    </div>

                    <div class="form-group">
                        <label for="code" class="form-label">Faculty Code</label>
                        <input type="text" class="form-control" id="code" name="code" required value="{{ $faculty->code }}">
                    </div>
